...
- Lead Scoring Case Study_final.ipynb : The python file showing coding and data analysis
...
- Summary.pdf : Summary on what's done in the entire py file and the learnings
## Libraries Used
- Numpy
- Pandas
- Matplotlib
